...
const statusConfig: Record<string, { bg: string; text: string; dot: string; label: string }> = {
  ...
  NOUVEAU: { bg: "bg-[var(--admin-info)]/10", text: "text-[var(--admin-info)]", dot: "bg-[var(--admin-info)]", label: "Nouveau" },
  EN_COURS: { bg: "bg-[var(--admin-warning)]/10", text: "text-[var(--admin-warning)]", dot: "bg-[var(--admin-warning)]", label: "En cours" },
  CONFIRME: { bg: "bg-[var(--admin-success)]/10", text: "text-[var(--admin-success)]", dot: "bg-[var(--admin-success)]", label: "Confirmé" },
  LIVRE: { bg: "bg-[var(--admin-success)]/10", text: "text-[var(--admin-success)]", dot: "bg-[var(--admin-success)]", label: "Livré" },
  ANNULE: { bg: "bg-[var(--admin-danger)]/10", text: "text-[var(--admin-danger)]", dot: "bg-[var(--admin-danger)]", label: "Annulé" },
