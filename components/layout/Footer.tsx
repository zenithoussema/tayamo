    ...
    <footer className="bg-bg border-t border-border">
      <div className="mx-auto max-w-7xl px-5 lg:px-8 py-16 lg:py-20">
        <div className="grid gap-12 md:grid-cols-3">
          <div>
            <h3 className="mb-4 text-xl font-bold tracking-tight text-text" style={{ fontFamily: "var(--font-heading)" }}>
              Tayamo Sport
            </h3>
          ...
          <div>
            <h4 className="mb-5 text-xs font-bold uppercase tracking-[0.15em] text-accent">
              {footer.quick_links}
            </h4>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 text-sm text-text-muted">
              <li className="flex items-center gap-3">
                <svg className="h-4 w-4 shrink-0 text-accent-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href={`tel:${contact.phone}`} className="hover:text-text transition-colors">
                  {contact.phone}
                </a>
              </li>
              {contact.address && (
                <li className="flex items-start gap-3">
                  <svg className="h-4 w-4 shrink-0 mt-0.5 text-accent-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-center gap-3">
                <svg className="h-4 w-4 shrink-0 text-accent-muted" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="border-t border-border">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-5 lg:px-8 py-6 md:flex-row">
          <p className="text-xs text-text-dim">
            &copy; {year} {footer.rights}
          </p>
          <p className="text-xs text-text-dim">{footer.follow_us}</p>
        </div>
      </div>
    </footer>
  );
